...
public class MealTestData {
    ...
    public static final Meal MEAL_1_ADMIN = new Meal(START_SEQ + 9, LocalDateTime.of(2015, Month.JUNE, 1, 14, 0), "Админ ланч", 510);
    public static final Meal MEAL_2_ADMIN = new Meal(START_SEQ + 10, LocalDateTime.of(2015, Month.JUNE, 1, 21, 0), "Админ ужин", 1500);

    public static Meal getNew() {
        return new Meal(LocalDateTime.now(), "Завтрак", 500);
    }
    ...
    public static Meal existDateTime() {
        return MEAL_1_USER;
    }
